...
class Ui_YUVEditor(object):
    def setupUi(self, YUVEditor):
        ...
        YUVEditor.setWindowModality(Qt.WindowModal)
        ...
        YUVEditor.setLayoutDirection(Qt.LeftToRight)
        YUVEditor.setToolButtonStyle(Qt.ToolButtonIconOnly)
        YUVEditor.setAnimated(True)
        YUVEditor.setTabShape(QTabWidget.Rounded)
