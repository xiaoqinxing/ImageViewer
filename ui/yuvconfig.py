...
class Ui_YUVConfig(object):
    ...
    def retranslateUi(self, YUVConfig):
        ...
        self.yuvformat.setItemText(2, QCoreApplication.translate("YUVConfig", u"YUV420", None))
        self.yuvformat.setItemText(3, QCoreApplication.translate("YUVConfig", u"YUYV", None))
        self.yuvformat.setItemText(4, QCoreApplication.translate("YUVConfig", u"YVYU", None))
